...
export function ScrollExperience() {
  ...
  useEffect(() => {
    ...
    const sectionObserver = new IntersectionObserver(entries => {
      ...
      sectionElements.forEach(section => section.classList.toggle("is-scroll-active", section.id === nextSection));
      document.documentElement.dataset.activeSection = nextSection;
    }, { rootMargin: "-25% 0px -55%", threshold: [0, .1, .25, .5] });
    ...
    sectionElements[0]?.classList.add("is-scroll-active");
    document.documentElement.dataset.activeSection = "top";
